 //https://www.youtube.com/watch?v=KnAsYNhI_CY
        ...
        function AddItemToTable(english, foreign, foreign2, foreign3) {
  ...
  const app = initializeApp(firebaseConfig);
        ...
        function AddAllItemsToTable(Question){    
            ...
            Question.forEach(element => {
                AddItemToTable(element.english, element.dutch, element.french, element.italian)
            });
        }
        ...
        function GetAllDataOnce() {
            ...
            get(child(dbRef, "Swtizerland_2009")) //naming error on our database, dont mind it
            .then((snapshot)=>{
                var questions =[];
