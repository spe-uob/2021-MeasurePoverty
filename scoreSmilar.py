...
#use on a list of questions
def smilar_sentence2(quesntion_list,target_list):
    ListAfterSmilar=[]
    for q in quesntion_list:
        ListAfterSmilar.append(similar_sentence(q,target_list))
    return ListAfterSmilar

#the following is for testing
quesnions= ["Does your household have three telephone (fixed landline or mobile)?","Does your household have a bus for private use?"]
print(smilar_sentence2(quesnions,array3))
#testing end
