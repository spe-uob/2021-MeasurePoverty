...
var firebaseRef = firebase.database().ref("Poland2009")
...
var firebaseRef2 = firebase.database().ref("Poland2009")
...
var firebaseRef3 = firebase.database().ref("Poland2009")
firebaseRef3.on("value" , function(snapshot){
    snapshot.forEach(function(element){
        document.querySelector('#polish2009').innerHTML += `
               <div>${element.val()}</div>
               `
    });
})
