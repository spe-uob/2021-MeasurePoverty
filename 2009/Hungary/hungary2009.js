...
var firebaseRef = firebase.database().ref("Hungary2009")
...
var firebaseRef2 = firebase.database().ref("Hungary2009")
...
var firebaseRef3 = firebase.database().ref("Hungary2009")
firebaseRef3.on("value" , function(snapshot){
    snapshot.forEach(function(element){
        document.querySelector('#hungarian2009').innerHTML += `
               <div>${element.val()}</div>
               `
    });
})
